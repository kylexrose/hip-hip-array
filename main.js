...
const challenge7 = ["A", "B", "C", "D", "E"];
for (let i = 0; i < challenge7.length; i++){
  console.log(challenge7[i]);
}
// Challenge 8
// Make a new EMPTY array and fill it with five values of your choice using BOTH .push AND .unshift, and then console.log out each value individually.
const challenge8 = [];
challenge8.push("F", "G");
challenge8.unshift("H", "I", "J");
for (let i = 0; i < challenge8.length; i++){
  console.log(challenge8[i]);
}
...
let studentsCopy11 = students.slice(3, 10);
for (let i = 0; i < studentsCopy11.length; i++){
  console.log(studentsCopy11[i]);
}
for(let i = 0; i < students.length; i++){
  console.log(students[i]);
}
...
dinosaursString = dinosaurs.join("*");
...
const concatenated = primaries.concat(secondaries);
